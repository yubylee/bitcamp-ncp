...
public class JdbcStudentDao implements StudentDao {
  ...
  public void insert(Student s) {
    try (Statement stmt = con.createStatement()) {
      ...
      String sql = String.format("insert into app_student(name, tel, pst_no, bas_addr, det_addr, work, gender, level) "
  ...
  public Student findByNo(int no) {
    try (Statement stmt = con.createStatement();
        ResultSet rs = stmt.executeQuery(
            "select student_id, name, tel, pst_no, bas_addr, det_addr, work, gender, level, created_date "
      ...
      if(rs.next()) {
        ...
        s.setBasicAddress(rs.getNString("bas_addr"));
        s.setDetailAddress(rs.getNString("det_addr"));
        s.setWorking(rs.getBoolean("work"));
